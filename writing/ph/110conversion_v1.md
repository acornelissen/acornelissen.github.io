...
{% include figure.html variant="inline" url="/assets/wr/110/15.jpeg" description="Front, under the rangefinder lip, off center to the right" %}
</div>
...
{% include figure.html variant="inline" url="/assets/wr/110/30.jpeg" description="So ergonomic" %}
</div>
