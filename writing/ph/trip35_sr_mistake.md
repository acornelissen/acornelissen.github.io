...
{% include figure.html url="/assets/wr/trip35_sr_mistake/3.png" description="Scanned negatives" %}
...
{% include figure.html url="/assets/wr/trip35_sr_mistake/4.png" description="A particularly dense negative" %}

Well, let's pull up the excellent Negative Lab Pro and see what we have to work with after it applies its initial sorcery.

{% include figure.html url="/assets/wr/trip35_sr_mistake/5.png" description="After NLP worked its initial magic" %}
...
{% include figure.html url="/assets/wr/trip35_sr_mistake/6.png" description="Now this I can work with" %}
...
{% include figure.html url="/assets/wr/trip35_sr_mistake/7.jpg" description="The final product" %}
...
{% include figure.html variant="inline" url="/assets/wr/trip35_sr_mistake/11.jpg" description="Santa RAE 1000 at ISO 400 - Olympus Trip 35" %}
</div>
